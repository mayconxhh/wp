...
function fitclub_entry_meta() {
	...
	echo '<div class="entry-meta">';
   	...
   	?>
		...
		<span class="comments-link"><i class="fa fa-comments-o"></i><?php comments_popup_link( esc_html__( '0 Comentarios', 'fitclub' ), esc_html__( '1 Comentario', 'fitclub' ), esc_html__( ' % Comentarios', 'fitclub' ) ); ?></span>
		<?php }
...
function fitclub_footer_copyright_info() {
   ...
   $tg_link =  '<a href="'. 'https://themegrill.com/themes/fitclub' .'" target="_blank" title="'.esc_attr__( 'ThemeGrill', 'fitclub' ).'" rel="author">'.esc_html__( 'ThemeGrill', 'fitclub') .'</a>';
	...
	$adaptater_link =  '<a href="'. 'https://mayconxhh.herokuapp.com' .'" target="_blank" title="'.esc_attr__( 'Mayconxhh', 'fitclub' ).'" rel="author" >'.esc_html__( 'Mayconxhh', 'fitclub') .'</a>';

   $default_footer_value = '<span class="copyright-text">' . sprintf( esc_html__( 'Copyright &copy; %1$s %2$s.', 'fitclub' ), date( 'Y' ), $site_link ).' '.sprintf( esc_html__( 'Design By: %1$s.', 'fitclub' ), $tg_link ) .' '.sprintf(esc_html__('Adaptater by:%1$s', 'fitclub'), $adaptater_link). '</span>';
